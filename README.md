...
1. **"token"**: Get your API token from CloudFlare and ensure it has edit permissions. <a href="https://developers.cloudflare.com/fundamentals/api/get-started/create-token/" target="_blank">CloudFlare Instructions to Create a Token!</a>
